...
# Given the set animals = {"cat", "dog", "rabbit"}, add multiple items ["horse", "sheep"] to the set and 
...
# Given the set cities = {"New York", "Los Angeles", "Chicago"}, remove "Houston" which is not in the set without
#  raising an error.
...
seasons_to_set = set(seasons)           
print(seasons_to_set)           
...
# Given two sets, setA = {"a", "fruitb", "c"} and setB = {"c", "d", "e"}, 
...
# Create a set called prime_numbers with values {2, 3, 5, 7}. Add the number 11 to the set and 
# print the updated set.
prime_numbers = {2, 3, 5, 7}
prime_numbers.add(11)
print(prime_numbers)

# Given the set odd_numbers = {1, 3, 5, 7, 9}, remove a random item from the set and 
# print the updated set.
...
another_set2 = {"Amazon", "Facebook"}
print(tech_brands|another_set2)

# #  14. 	Create a set called students with values {"Alice", "Bob", "Charlie", "David"}. 
# # Use the remove method to remove "Charlie" from the set and print the updated set. 
# # Then try to remove "Eve" from the set and observe the behavior.
